...
// linear
function draww2wplot(dataset)
{
  document.getElementById("wordw2w").innerHTML = "";

  var margin = {top: 40, right: 40, bottom: 40, left: 140};
  var width = parseInt(document.getElementById("wordw2w").style.width,10)-margin.right -margin.left;
  var height = parseInt(document.getElementById("wordw2w").style.height,10)-margin.top-margin.bottom;
  ...
  var svg = d3.select("#wordw2w").append("svg")
  ...
  svg.append("text")             
    ...
    .text("Cosing Similarity Between Word Vectors")
    //.style("font-style","Italic")
    .style("font-famliy","sans-serif")
    .style("font-size","18px")
    //.style("font-weight","Bold");
